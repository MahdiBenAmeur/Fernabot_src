...
def similarity_percentage(word1: str, word2: str) -> int:
    """Find % of similarity between two words
    ...
    Returns:
        int: Percentage of similarity
    """
    match = SequenceMatcher(None, word1, word2)
